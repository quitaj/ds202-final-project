...
Most Genres appear fairly consistent. Heavy Metal started out strong but then suffered a steep decline afterwards. Hard Rock seems to suffer a similar fate with not as strong of a start. Film Score and Singer/Songwriter shows somewhat extreme flips between average ratings between the years with average ratings around 3.8

```{r}
df_final%>% filter(Genre_1 == "Hard Bop")%>% select(Genre_1,Album,Artist.Name, Year,Average.Rating)%>% arrange(desc(Average.Rating))%>% head(10)
```
...
Paranoid Black Sabbath 1970 4.19 Master of Reality Black Sabbath 1971 4.12 Black Sabbath Black Sabbath 1970 4.06 Painkiller Judas Priest 1990 4.00
...
Illmatic Nas 1994 4.20 Enter the Wu-Tang (36 Chambers) Wu-Tang Clan 1993 4.19

```{r}
df_final %>% select(Genre_1,Album,Artist.Name, Year,Average.Rating)%>% arrange(desc(Average.Rating))
```

**Top Ten Albums**

The Black Saint and the Sinner Lady by Mingus 1963 4.34 Avant-Garde Jazz In the Court of the Crimson King by King Crimson 1969 4.30 Progressive Rock A Love Supreme by John Coltrane 1965 4.30 Spiritual Jazz Wish You Were Here by Pink Floyd 1975 4.29 Progressive Rock To Pimp a Butterfly by Kendrick Lamar 2015 4.27 Conscious Hip Hop The Rise and Fall of Ziggy Stardust and the Spiders From Mars by David Bowie 1972 4.26 Glam Rock Madvillainy by Madvillain 2004 4.26 Abstract Hip Hop Abbey Road by The Beatles 1969 4.25 Pop Rock Remain in Light by Talking Heads 1980 4.25 New Wave Loveless by My Bloody Valentine 1991 4.24 Shoegaze
...
Wu-Tang Clan 4.19 Slint 4.15 Godspeed You Black Emperor! 4.145 Television 4.13 DJ Shadow 4.11\
...
df_final%>% mutate(
  Year = factor(Year)
  )%>%(filter(Year = c(1968,1969,1970,1971,1972,1973,1974,1975,1976,1977,1978,1979,1980,1981,1982)))
```
