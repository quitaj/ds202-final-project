...
This graph scores the average score that all albums recieved by the the year. My conclusion of a overall decresing score as the move from year to year is confirmed when looking at this graph.There is a huge increase in average score as you move towards the 70's but then it starts to decline shortly after. 
